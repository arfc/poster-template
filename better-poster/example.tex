...
% Right column
\setlength{\rightbarwidth}{0.26\paperwidth}
...
\author{Rafael Bailo}
\institution{Advanced Reactors and Fuel Cycles Group, \\University of Illinois Urbana-Champaign}
...
\section{Conclusion}
This is a great poster format! We cite: \cite{call_tag_techrep}.

%% This fills the space between the content and the logo
\vfill

%% Institution logo
\includegraphics[width=0.2\textwidth]{img/UIUC_Logo.png}\\
